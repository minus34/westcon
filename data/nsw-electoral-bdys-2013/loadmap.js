...
var themeGrades = [0, 250, 500, 1000, 2000, 4000];
...
function init() {
    ...
    info.update = function (props) {
        this._div.innerHTML = (props ? '<h4>' + props.name +
            '</h4><b>' + parseInt(props.o_motorists).toLocaleString() + ' </b> motorists (' + parseInt(100 * parseFloat(props.o_motorists) / parseFloat(props.electors)).toString() + '%)<br/>' +
            '</h4><b>' + parseInt(props.d_motorists).toLocaleString() + ' </b> motorists drive to here for work<br/>'
    ...
    map.attributionControl.addAttribution('<br/>Data © <a href="http://www.bts.nsw.gov.au/">NSW Bureau of Transport Statistics</a>, <a href="http://www.elections.nsw.gov.au/">NSW Electoral Commission</a>');
